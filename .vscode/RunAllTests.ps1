...
[string] $dscResourceTestsPath = Join-Path -Path $repoRoot -ChildPath 'Modules\FSRMDsc\DSCResource.Tests'
...
{
    & git @('clone','https://github.com/PowerShell/DscResource.Tests.git',(Join-Path -Path $repoRoot -ChildPath 'Modules\FSRMDsc\DSCResource.Tests\'))
}
