...
try
{
    InModuleScope $script:dscResourceName {
        ...
        Describe 'DSC_FSRMQuotaTemplateAction\Get-TargetResource' {
        ...
        Describe 'DSC_FSRMQuotaTemplateAction\Set-TargetResource' {
            Context 'Quota template does not exist' {
        ...
        Describe 'DSC_FSRMQuotaTemplateAction\Test-TargetResource' {
            Context 'Quota template does not exist' {
                Mock -CommandName Get-FsrmQuotaTemplate -MockWith { throw (New-Object -TypeName Microsoft.PowerShell.Cmdletization.Cim.CimJobException) }
